...
public class PropertyRepository : IPropertyRepository
{
    ...
    private static Property MapToModel(PropertyEntity entity) => new()
    {
        ...
        CommuteMinutesPrimary = entity.CommuteMinutesPrimary,
        CommuteMinutesSecondary = entity.CommuteMinutesSecondary,
        MonthlyUtilities = entity.MonthlyUtilities,
    ...
    private static PropertyEntity MapToEntity(Property model) => new()
    {
        ...
        CommuteMinutesPrimary = model.CommuteMinutesPrimary,
        CommuteMinutesSecondary = model.CommuteMinutesSecondary,
        MonthlyUtilities = model.MonthlyUtilities,
